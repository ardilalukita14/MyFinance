...
import com.example.managefinance.R.layout
import com.example.managefinance.helpers.InputValidation
import com.example.managefinance.modal.User
import com.example.managefinance.sql.DatabaseHelper
...
//     */
    ...
    private fun postDataToSQLite() {
        ...
        if (!inputValidation!!.isInputEditTextFilled(password ,  "Enter Valid Password")) {
            return
        }
